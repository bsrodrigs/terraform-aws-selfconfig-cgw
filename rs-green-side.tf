...
resource "aws_instance" "green_vpn_inst" {
  ...
  vpc_security_group_ids = concat(aws_security_group.green_vpn_inst_ipsec.id, aws_security_group.green_vpn_inst_green_traffic.id, aws_security_group.green_vpn_inst_ssh[0].id)
